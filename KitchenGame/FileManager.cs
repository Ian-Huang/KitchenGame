...
public class SettingTag
{
    ...
    public const string ColdDownTime = "ColdDownTime";
    public const string ConfidenceValue = "ConfidenceValue";
    public const string PictureSize = "PictureSize";
    public const string Language = "Language";
    public const string MaterialMax = "MaterialMax";
    public const string MaterialMin = "MaterialMin";    
...
public class SettingData
{
    ...
    public string ColdDownTime;
    public string ConfidenceValue;
    public string PictureSize;
    public string Language;
    public string MaterialMin;
    public string MaterialMax;
    ...
    public SettingData(string gameTime, string coldDownTime, string confidenceValue, string pictureSize, string language, string materialMax, string materialMin, string createMaxTime, string createMinTime, string maxDownSpeed, string minDownSpeed, string successSound, string failSound)
    {
...
public class FileManager
{
            ...
            switch (reader.NodeType)
            {
                case XmlNodeType.Element:
                    ...
                    if (tagName.Equals(SettingTag.SetTag))
                    {
                        ...
                        this.settingData = new SettingData(reader[SettingTag.GameTime],
                                                           reader[SettingTag.ColdDownTime],
                                                           reader[SettingTag.ConfidenceValue],
                                                           reader[SettingTag.PictureSize],
                                                           reader[SettingTag.Language],
                                                           reader[SettingTag.MaterialMax],
                                                           reader[SettingTag.MaterialMin],
    ...
    //                newMachine.SetAttribute(SettingTag.ColdDownTime, "3");
    ...
    //                document.Save(filename);
    //                this.settingData = new SettingData("3","0.6", "100", "en-US", "6", "4", "3", "1", "Success.mp3", "Fail.mp3");
    //                return false;
    //            }
    //            break;
